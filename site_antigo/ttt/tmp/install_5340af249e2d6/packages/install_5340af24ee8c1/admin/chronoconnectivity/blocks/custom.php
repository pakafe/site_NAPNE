...
class Custom {
	...
	public static function config($area = 'front'){
		...
		echo \GCore\Helpers\Html::formLine('Connection[extras]['.$area.'][blocks][custom][header]', array('type' => 'textarea', 'label' => l_('HEADER_CODE'), 'style' => 'width:auto;', 'rows' => 18, 'cols' => 80, 'sublabel' => 'HTML/PHP code for the header of the list, this code is rendered only once.'));
		echo \GCore\Helpers\Html::formLine('Connection[extras]['.$area.'][blocks][custom][body]', array('type' => 'textarea', 'label' => l_('BODY_CODE'), 'style' => 'width:auto;', 'rows' => 24, 'cols' => 80, 'sublabel' => 'HTML/PHP code for each record in the list, this code is rendered once for every record in 1 page.'));
		echo \GCore\Helpers\Html::formLine('Connection[extras]['.$area.'][blocks][custom][footer]', array('type' => 'textarea', 'label' => l_('FOOTER_CODE'), 'style' => 'width:auto;', 'rows' => 18, 'cols' => 80, 'sublabel' => 'HTML/PHP code for the footer of the list, this code is rendered only once.'));
